      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="grid md:grid-cols-2 gap-6">
            <div className="space-y-3">
              <h4 className="font-semibold text-foreground">Application Support</h4>
              <div className="space-y-2 text-sm">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>support@haulerplatform.com</span>
                </div>
              </div>
              <p className="text-xs text-muted-foreground">Available Monday - Friday, 8:00 AM - 6:00 PM SAST</p>
            </div>

            <div className="space-y-3">
              <h4 className="font-semibold text-foreground">Document Issues</h4>
              <div className="space-y-2 text-sm">
                <div className="flex items-center gap-2">
                  <Mail className="h-4 w-4 text-muted-foreground" />
                  <span>documents@haulerplatform.com</span>
                </div>
              </div>
              <p className="text-xs text-muted-foreground">
                For questions about document requirements or resubmissions
              </p>
            </div>
          </div>
        </CardContent>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p className="text-sm text-muted-foreground">
            Keep a copy of your application details for your records. You can download or print a summary below.
          </p>
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <Button variant="outline" onClick={handlePrintSummary} className="flex items-center gap-2 bg-transparent">
          ...
          <div className="bg-amber-50 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-800 rounded-lg p-4 mt-4">
            <h4 className="font-semibold text-amber-900 dark:text-amber-100 mb-2">Important Reminders</h4>
            <ul className="text-sm text-amber-800 dark:text-amber-200 space-y-1">
              <li>
                • Keep your application ID safe: <strong>{applicationId}</strong>
              </li>
              <li>• Ensure your documents remain valid during the review period</li>
              <li>• Update us immediately if any of your contact details change</li>
              <li>• Check your email and SMS regularly for updates</li>
            </ul>
          </div>
        </CardContent>
      </Card>
